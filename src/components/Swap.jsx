import React, { useState, useEffect } from 'react';
 ...
 function Swap() {
     ...
     const { config: swapConfig, error: prepareErrorWrite } = usePrepareContractWrite({
       ...tokenContract,
         functionName: 'transfer',
         args: [address, ethers.parseEther(fromAmount)],
          enabled: isConnected && fromAmount !== "" && address !== "0x0" && tokenContractAddress !== "0x0"
     })

     useEffect(() => {
       setPrepareError(prepareErrorWrite)
       console.log(prepareErrorWrite);
     }, [prepareErrorWrite])
